...
'''
LOGIC - Get model to first evaluate to a low R^2 value and then you can evaluate the under 5-pixel error, etc using:
'''
#
#
#num_under_five = 0
...
#    if(np.sqrt(pred[0]-Y[i][0])^2+(pred[0]-Y[i][0])^2)<5):
#        num_under_five += 1
